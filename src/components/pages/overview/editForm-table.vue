<template>
  <form id="contentForm" @submit.prevent="validateBeforeSubmit" @change="itemChanged"
        v-bind:class="{ changed: isDirty }">
    <td>
    ...
    <td>
      <md-button class="md-icon-button" @click="dialog.active = true">
