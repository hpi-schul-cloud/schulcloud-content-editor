...
export default {
  ...
  form: {
    ...
    description_tooltip: 'Geben Sie Geben Sie eine Beschreibung für den Inhalt an.',
  ...
  dialog: {
    ...
    content: 'Möchten Sie diesen Inhalt wirklich unwiderruflich aus der Schul-Cloud entfernen?',
